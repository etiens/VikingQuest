...
#if UNITY_EDITOR
[CustomPropertyDrawer (typeof(CameraPath.WaypointList))]
public class WaypointListDrawer : PropertyDrawer
{
	...
	public override void OnGUI (Rect position, SerializedProperty property, GUIContent label)
	{
		...
		{
			var circuit = property.FindPropertyRelative("circuit").objectReferenceValue as CameraPath;
